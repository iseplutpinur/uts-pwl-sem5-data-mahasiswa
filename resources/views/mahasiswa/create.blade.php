...
@section('content')
    <div class="container mt-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('mahasiswa.store') }}" method="POST" enctype="multipart/form-data" id="mainform">
                    @csrf
                    <div class="row mb-3">
                        <label for="npm" class="col-sm-2 col-form-label">Nomor Pokok Mahasiswa</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" value="{{ old('npm') }}"name="npm"
                                id="npm" required placeholder="Silahkan masukan Nomor Pokok Mahasiswa">
                        </div>
                    </div>
                    @error('npm')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" value="{{ old('prodi_id') }}"name="prodi_id" id="prodi_id"
                                required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{ old('nama') }}"name="nama"
                                id="nama" required placeholder="Silahkan masukan nama mahasiswa">
                        </div>
                    </div>
                    @error('nama')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea type="number" class="form-control" name="alamat" id="alamat" required
                                placeholder="Silahkan masukan alamat mahasiswa">{{ old('alamat') }}</textarea>
                        </div>
                    </div>
                    @error('thn_masuk')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="2000" max="{{ date('Y') }}" class="form-control"
                                ...
                                placeholder="Silahkan masukan tahun masuk mahasiswa">
                        </div>
                    </div>
                    @error('thn_masuk')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
